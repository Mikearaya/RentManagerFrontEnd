...
export class CustomerViewComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns = ['select', 'first_name', 'last_name', 'mobile_number', 'driving_licence_id', 'registered_on'];
  ...
  manageView(filteredColumns) {this.displayedColumns = filteredColumns.push('select'); }
